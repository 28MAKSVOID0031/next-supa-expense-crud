...
export default function ExpenseReport () {
    ...
    async function HandleAddNewExpense(formData) {
        if (editingUser) {
            await editUserAction(editingUser.id, formData, "/expense-report");
            setEditingUser(null);
        } else {
            await addNewUserAction(formData, "/expense-report");
        }
    ...
    async function HandleDeleteExpenseData(currentUserId) {
        await deleteUserAction(currentUserId, "/expense-report");
        HandleFetchUserData();
    }
